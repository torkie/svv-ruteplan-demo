...
describe("fromStringRadix32 Tests", () => {
    it("+1lmo -> 55000", () => {
        expect(SVV.RoutePlanning.Helpers.CompressedGeometryHelper.fromStringRadix32("+1lmo")).toBe(55000);
    });
...
describe("compressedGeometry Tests", () => {
    it("+34+1lmo+0 -> [550 0]", () => {
        var res = SVV.RoutePlanning.Helpers.CompressedGeometryHelper.extractPointsFromCompressedGeometry("+34+1lmo+0");
    ...
    it("+0+1+1+34+1dukkk+b7co0o+9c+0+0+34-9c-34|+34+0+71+0+71", () => {
        var res = <SVV.RoutePlanning.Helpers.Xyz[]>SVV.RoutePlanning.Helpers.CompressedGeometryHelper.extractPointsFromCompressedGeometry("+0+1+1+34+1dukkk+b7co0o+9c+0+0+34-9c-34|+34+0+71+0+71");
        expect(res).toBeDefined();
